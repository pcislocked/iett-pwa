  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <span className="flex-1 text-[13px] font-bold text-text-primary truncate leading-tight font-mono">{code}</span>
      ...
      <div className="mt-0.5 pl-[26px]">
        <span className="text-[11px] text-text-secondary truncate block leading-tight">{name}</span>
      </div>
    ...
    <PullToRefresh onRefresh={async () => { window.location.reload(); await new Promise(r => setTimeout(r, 600)); }}>
      ...
      <section>
        ...
        <div>
          ...
          <QuickRow
            to="/arac-sorgu"
            label={t('nav.aracQuery', { defaultValue: 'Kapı No Sorgulama' })}
            sub={t('home.aracQueryDesc', { defaultValue: 'arac.iett.gov.tr üzerinden detaylı bilgi alın' })}
            icon={
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="w-5 h-5">
